...
void DSSV::soSanhThoiGianSapXep1()
{
    ...
    //      << endl;
    // inDanhSachSV();
    cout << "\n\t\tQuick sort time: " << ((double)end2 - start2) / CLOCKS_PER_SEC << " s" ;
    ...
    //      << endl;
    // inDanhSachSV();
    cout << "\n\t\tSelection sort time: " << ((double)end1 - start1) / CLOCKS_PER_SEC << " s\n" << endl;
}
...
void DSSV::soSanhThoiGianSapXep2()
{
    ...
    //      << endl;
    // inDanhSachSV();
    cout << "\t\tQuick sort time: " << ((double)end2 - start2) / CLOCKS_PER_SEC << " s\n" << endl;
}
